...
internal object Constants {
    const val DOCUSIGN_INTEGRATOR_KEY = "8ada9b8f-0730-47c0-b6dd-4945e53bf73a"  // YOUR DOCUSIGN INTEGRATOR KEY
    const val CLIENT_SECRET_KEY = "f493950e-0731-4dd5-b632-f59069a677a7"   // YOUR CLIENT SECRET KEY
    const val REDIRECT_URI = "https://demo.docusign.net"  // YOUR REDIRECT URI
    ...
    const val PORTFOLIO_A_DOCUMENT_FILE_NAME = "conservation.pdf"
    const val PORTFOLIO_B_DOCUMENT_FILE_NAME = "conservation.pdf"
